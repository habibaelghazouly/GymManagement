...
public class AddTrainerWindow extends javax.swing.JFrame {
    ...
    public boolean validations(String name, String speciality, String phoneNum) {
        if (!checkLetters(name) || !checkLetters(speciality)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validations(name, speciality, phoneNum)) {

            if (ID.equals("") || name.equals("") || email.equals("") || speciality.equals("") || phoneNum.equals("")) {
                ...
                jTextField4.setText("");
                jTextField5.setText("");
            } else if (!ar.database.contains(ID)) {
                ar.addTrainer(ID, name, email, speciality, phoneNum);
                ar.logout();
                JOptionPane.showMessageDialog(this, "The trainer with ID= " + ID + " has been added successfully.", "Message", JOptionPane.PLAIN_MESSAGE);
                this.dispose();
                new AdminRoleWindow().setVisible(true);
            } else {
                JOptionPane.showMessageDialog(this, "The trainer with ID= " + ID + " already exists!", "Message", JOptionPane.ERROR_MESSAGE);
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
