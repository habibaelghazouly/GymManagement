...
public class RemoveTrainerWindow extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ID.equals("")) {
            ...
            jTextField1.setText("");
        } else if (ad.database.contains(ID)) {
            ad.removeTrainer(ID);
            ad.logout();
            JOptionPane.showMessageDialog(this, "The trainer with ID= " + ID + " has been deleted successfully.", "Message", JOptionPane.PLAIN_MESSAGE);
            this.dispose();
            new AdminRoleWindow().setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "The trainer with ID= " + ID + " doesn't exist!", "Message", JOptionPane.ERROR_MESSAGE);
            jTextField1.setText("");
             this.dispose();
            new AdminRoleWindow().setVisible(true);
        }
