...
public class ViewClassesWindow extends javax.swing.JFrame {
    ...
    //To fill the data in the table to display it 
     private void generateClassData() {
        ...
        ArrayList<Class> classes = tr.getListOfClasses();
        ...
        if (!classes.isEmpty()) {
            for (Class c : classes) {
                String[] splitted = c.lineRepresentation().split(",");
                String classId = splitted[0];
                String className = splitted[1];
                String trainerId = splitted[2];
                String duration = splitted[3];
                String maxPart = splitted[4];

                model.addRow(new Object[]{classId, className, trainerId, duration, maxPart});
            }
        }
    }
